...
func (pg *Postgresql) DSN(settings *pkg.Settings) string {
...
func (pg *Postgresql) GetTables() (tables []*pkg.Table, err error) {
...
func (pg *Postgresql) GetColumnsOfTable(table *pkg.Table) (err error) {
...
func (pg *Postgresql) IsString(column pkg.Column) bool {
...
func (pg *Postgresql) IsText(column pkg.Column) bool {
...
func (pg *Postgresql) IsInteger(column pkg.Column) bool {
...
func (pg *Postgresql) IsFloat(column pkg.Column) bool {
...
func (pg *Postgresql) IsTemporal(column pkg.Column) bool {
