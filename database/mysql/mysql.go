...
func (mysql *Mysql) DSN(settings *tablestogo.Settings) string {
...
func (mysql *Mysql) GetTables() (tables []*tablestogo.Table, err error) {
...
func (mysql *Mysql) GetColumnsOfTable(table *tablestogo.Table) (err error) {
...
func (mysql *Mysql) IsPrimaryKey(column tablestogo.Column) bool {
	return strings.Contains(column.ColumnKey, "PRI")
}

// IsAutoIncrement checks if column is a auto_increment column
func (mysql *Mysql) IsAutoIncrement(column tablestogo.Column) bool {
...
func (mysql *Mysql) IsString(column tablestogo.Column) bool {
...
func (mysql *Mysql) IsText(column tablestogo.Column) bool {
...
func (mysql *Mysql) IsInteger(column tablestogo.Column) bool {
...
func (mysql *Mysql) IsFloat(column tablestogo.Column) bool {
...
func (mysql *Mysql) IsTemporal(column tablestogo.Column) bool {
