...
(
    timestamp_with_time_zone_def_const_unique_check_pk timestamp with time zone PRIMARY KEY UNIQUE CHECK (
        timestamp_with_time_zone_def_const_unique_check_pk > '2020-03-01 12:34:56+8' ) DEFAULT '2020-03-01 12:34:56+8'
);
...
(
    timestamp_with_time_zone_def_const_unique_check_pk_ref timestamp with time zone PRIMARY KEY UNIQUE CHECK (
        timestamp_with_time_zone_def_const_unique_check_pk_ref >
...
(
    timestamp_with_time_zone_def_func_unique_check_pk timestamp with time zone PRIMARY KEY UNIQUE CHECK (
        timestamp_with_time_zone_def_func_unique_check_pk > '2020-03-01 12:34:56+8' ) DEFAULT now()
);
...
(
    timestamp_with_time_zone_def_func_unique_check_pk_ref timestamp with time zone PRIMARY KEY UNIQUE CHECK (
        timestamp_with_time_zone_def_func_unique_check_pk_ref >
