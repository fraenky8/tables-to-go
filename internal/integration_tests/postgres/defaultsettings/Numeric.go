...
type Numeric struct {
	Numeric                    sql.NullFloat64 `db:"numeric"`
	NumericPrec                sql.NullFloat64 `db:"numeric_prec"`
	NumericPrecScale           sql.NullFloat64 `db:"numeric_prec_scale"`
	...
	NumericRefDefConst         sql.NullFloat64 `db:"numeric_ref_def_const"`
	NumericRefDefFunc          sql.NullFloat64 `db:"numeric_ref_def_func"`
