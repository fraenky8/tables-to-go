...
type Numeric struct {
	Numeric                    *float64 `db:"numeric"`
	NumericPrec                *float64 `db:"numeric_prec"`
	NumericPrecScale           *float64 `db:"numeric_prec_scale"`
	...
	NumericRefDefConst         *float64 `db:"numeric_ref_def_const"`
	NumericRefDefFunc          *float64 `db:"numeric_ref_def_func"`
