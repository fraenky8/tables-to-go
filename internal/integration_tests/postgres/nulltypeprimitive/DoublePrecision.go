...
type DoublePrecision struct {
	DoublePrecision                    *float64 `db:"double_precision"`
	...
	DoublePrecisionRefDefConst         *float64 `db:"double_precision_ref_def_const"`
	DoublePrecisionRefDefFunc          *float64 `db:"double_precision_ref_def_func"`
