...
(
    ...
    year_nn_check year NOT NULL,
    year_nn_ref year NOT NULL REFERENCES year_ref(year_ref),
    year_nn_def_const year NOT NULL DEFAULT '2020',
    year_nn_def_func year NOT NULL DEFAULT '2020',
    year_nn_unique_check year NOT NULL UNIQUE,

    year_unique year UNIQUE,
    year_unique_check year UNIQUE,
    year_unique_ref year UNIQUE REFERENCES year_ref(year_ref),
    year_unique_def_const year UNIQUE DEFAULT '2020',
    year_unique_def_func year UNIQUE DEFAULT '2020',

    year_check year,
    year_check_ref year REFERENCES year_ref(year_ref),
    year_check_def_const year DEFAULT '2020',
    year_check_def_func year DEFAULT '2020',

    year_ref year REFERENCES year_ref(year_ref),
    year_ref_unique_check year UNIQUE REFERENCES year_ref(year_ref),

    year_def_const year DEFAULT '2020',
    year_def_const_unique_check year UNIQUE DEFAULT '2020',

    year_def_func year DEFAULT '2020',
    year_def_func_unique_check year UNIQUE DEFAULT '2020'
);
...
(
    year_pk_def_func year PRIMARY KEY DEFAULT '2020'
);
...
(
    year_nn_unique_check_pk year PRIMARY KEY NOT NULL UNIQUE
);

DROP TABLE IF EXISTS year_nn_unique_check_pk_ref;
CREATE TABLE year_nn_unique_check_pk_ref
(
    year_nn_unique_check_pk_ref year PRIMARY KEY NOT NULL UNIQUE REFERENCES year_ref(year_ref)
);
