...
(
    ...
    bigint_nn_check               bigint NOT NULL,

    bigint_unique                 bigint UNIQUE,
    bigint_unique_check           bigint UNIQUE,
    bigint_unique_ref             bigint UNIQUE REFERENCES bigint_ref (bigint_ref),
    bigint_unique_def_const       bigint UNIQUE DEFAULT 42,
    bigint_unique_def_func        bigint UNIQUE DEFAULT 42,

    bigint_check                  bigint,
    bigint_check_ref              bigint REFERENCES bigint_ref (bigint_ref),
    bigint_check_def_const        bigint        DEFAULT 42,
    bigint_check_def_func         bigint        DEFAULT 42,

    bigint_ref                    bigint REFERENCES bigint_ref (bigint_ref),
    bigint_ref_unique_check       bigint UNIQUE REFERENCES bigint_ref (bigint_ref),

    bigint_def_const              bigint        DEFAULT 42,
    bigint_def_const_unique_check bigint UNIQUE DEFAULT 42,

    bigint_def_func               bigint        DEFAULT 42,
    bigint_def_func_unique_check  bigint UNIQUE DEFAULT 42
);
...
(
    bigint_pk_def_func bigint PRIMARY KEY DEFAULT 42
);
...
(
    bigint_nn_unique_check_pk bigint PRIMARY KEY NOT NULL UNIQUE
);

DROP TABLE IF EXISTS bigint_nn_unique_check_pk_ref;
CREATE TABLE bigint_nn_unique_check_pk_ref
(
    bigint_nn_unique_check_pk_ref bigint PRIMARY KEY NOT NULL UNIQUE REFERENCES bigint_ref (bigint_ref)
);
