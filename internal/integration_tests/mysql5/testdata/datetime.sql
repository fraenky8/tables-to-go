...
(
    ...
    datetime_nn_check               datetime NOT NULL,
    ...
    datetime_nn_def_func            datetime NOT NULL DEFAULT '2020-03-01 12:34:56',
    datetime_nn_unique_check        datetime NOT NULL UNIQUE,

    datetime_unique                 datetime UNIQUE,
    datetime_unique_check           datetime UNIQUE,
    ...
    datetime_unique_def_func        datetime UNIQUE   DEFAULT '2020-03-01 12:34:56',

    datetime_check                  datetime,
    datetime_check_ref              datetime REFERENCES datetime_ref (datetime_ref),
    datetime_check_def_const        datetime          DEFAULT '2020-03-01 12:34:56',
    datetime_check_def_func         datetime          DEFAULT '2020-03-01 12:34:56',

    datetime_ref                    datetime REFERENCES datetime_ref (datetime_ref),
    datetime_ref_unique_check       datetime UNIQUE REFERENCES datetime_ref (datetime_ref),

    datetime_def_const              datetime          DEFAULT '2020-03-01 12:34:56',
    datetime_def_const_unique_check datetime UNIQUE   DEFAULT '2020-03-01 12:34:56',

    datetime_def_func               datetime          DEFAULT '2020-03-01 12:34:56',
    datetime_def_func_unique_check  datetime UNIQUE   DEFAULT '2020-03-01 12:34:56'
);
...
(
    datetime_pk_def_func datetime PRIMARY KEY DEFAULT '2020-03-01 12:34:56'
);
...
(
    datetime_nn_unique_check_pk datetime PRIMARY KEY NOT NULL UNIQUE
);

DROP TABLE IF EXISTS datetime_nn_unique_check_pk_ref;
CREATE TABLE datetime_nn_unique_check_pk_ref
(
    datetime_nn_unique_check_pk_ref datetime PRIMARY KEY NOT NULL UNIQUE REFERENCES datetime_ref (datetime_ref)
);
...
(
    datetime_unique_check_pk datetime PRIMARY KEY UNIQUE
);

DROP TABLE IF EXISTS datetime_unique_check_pk_ref;
CREATE TABLE datetime_unique_check_pk_ref
(
    datetime_unique_check_pk_ref datetime PRIMARY KEY UNIQUE REFERENCES datetime_ref (datetime_ref)
);

DROP TABLE IF EXISTS datetime_check_pk;
CREATE TABLE datetime_check_pk
(
    datetime_check_pk datetime PRIMARY KEY
);

DROP TABLE IF EXISTS datetime_def_const_unique_check_pk;
CREATE TABLE datetime_def_const_unique_check_pk
(
    datetime_def_const_unique_check_pk datetime PRIMARY KEY UNIQUE DEFAULT '2020-03-01 12:34:56'
);

DROP TABLE IF EXISTS datetime_def_const_unique_check_pk_ref;
CREATE TABLE datetime_def_const_unique_check_pk_ref
(
    datetime_def_const_unique_check_pk_ref datetime PRIMARY KEY UNIQUE DEFAULT '2020-03-01 12:34:56' REFERENCES datetime_ref (datetime_ref)
);

DROP TABLE IF EXISTS datetime_def_func_unique_check_pk;
CREATE TABLE datetime_def_func_unique_check_pk
(
    datetime_def_func_unique_check_pk datetime PRIMARY KEY UNIQUE DEFAULT '2020-03-01 12:34:56'
);

DROP TABLE IF EXISTS datetime_def_func_unique_check_pk_ref;
CREATE TABLE datetime_def_func_unique_check_pk_ref
(
    datetime_def_func_unique_check_pk_ref datetime PRIMARY KEY UNIQUE DEFAULT '2020-03-01 12:34:56' REFERENCES datetime_ref (datetime_ref)
);
