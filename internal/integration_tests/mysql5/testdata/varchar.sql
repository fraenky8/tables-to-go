...
(
    ...
    varchar_nn_check_cmp           varchar(10) NOT NULL,
    varchar_nn_check_fn            varchar(10) NOT NULL,
    varchar_nn_ref                 varchar(10) NOT NULL REFERENCES varchar_ref (varchar_ref),
    varchar_nn_def_const           varchar(10) NOT NULL DEFAULT '42',
    varchar_nn_def_func            varchar(10) NOT NULL DEFAULT 42,
    varchar_nn_unique_check        varchar(10) NOT NULL UNIQUE,

    varchar_unique                 varchar(10) UNIQUE,
    varchar_unique_check           varchar(10) UNIQUE,
    ...
    varchar_unique_def_func        varchar(10) UNIQUE   DEFAULT 42,

    varchar_check                  varchar(10),
    varchar_check_ref              varchar(10) REFERENCES varchar_ref (varchar_ref),
    varchar_check_def_const        varchar(10)          DEFAULT '42',
    varchar_check_def_func         varchar(10)          DEFAULT 42,

    varchar_ref                    varchar(10) REFERENCES varchar_ref (varchar_ref),
    varchar_ref_unique_check       varchar(10) UNIQUE REFERENCES varchar_ref (varchar_ref),

    varchar_def_const              varchar(10)          DEFAULT '42',
    varchar_def_const_unique_check varchar(10) UNIQUE   DEFAULT '42',

    varchar_def_func               varchar(10)          DEFAULT 42,
    varchar_def_func_unique_check  varchar(10) UNIQUE   DEFAULT 42
);
...
(
    varchar_pk_def_func varchar(10) PRIMARY KEY DEFAULT 42
);
...
(
    varchar_nn_unique_check_pk varchar(10) PRIMARY KEY NOT NULL UNIQUE
);

DROP TABLE IF EXISTS varchar_nn_unique_check_pk_ref;
CREATE TABLE varchar_nn_unique_check_pk_ref
(
    varchar_nn_unique_check_pk_ref varchar(10) PRIMARY KEY NOT NULL UNIQUE REFERENCES varchar_ref (varchar_ref)
);
