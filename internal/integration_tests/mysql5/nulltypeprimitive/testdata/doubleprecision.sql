...
DROP TABLE IF EXISTS double_precision_table;
...
(
    ...
    double_precision_nn_check               double precision NOT NULL,
    ...
    double_precision_nn_def_func            double precision NOT NULL DEFAULT 42,
    double_precision_nn_unique_check        double precision NOT NULL UNIQUE,

    double_precision_unique                 double precision UNIQUE,
    double_precision_unique_check           double precision UNIQUE,
    ...
    double_precision_unique_def_func        double precision UNIQUE   DEFAULT 42,

    double_precision_check                  double precision,
    double_precision_check_ref              double precision REFERENCES double_precision_ref (double_precision_ref),
    double_precision_check_def_const        double precision          DEFAULT 42,
    double_precision_check_def_func         double precision          DEFAULT 42,

    double_precision_ref                    double precision REFERENCES double_precision_ref (double_precision_ref),
    double_precision_ref_unique_check       double precision UNIQUE REFERENCES double_precision_ref (double_precision_ref),

    double_precision_def_const              double precision          DEFAULT 42,
    double_precision_def_const_unique_check double precision UNIQUE   DEFAULT 42,

    double_precision_def_func               double precision          DEFAULT 42,
    double_precision_def_func_unique_check  double precision UNIQUE   DEFAULT 42
);
...
(
    double_precision_pk_def_func double precision PRIMARY KEY DEFAULT 42
);
...
(
    double_precision_nn_unique_check_pk double precision PRIMARY KEY NOT NULL UNIQUE
);
...
(
    double_precision_unique_check_pk double precision PRIMARY KEY UNIQUE
);

DROP TABLE IF EXISTS double_precision_unique_check_pk_ref;
CREATE TABLE double_precision_unique_check_pk_ref
(
    double_precision_unique_check_pk_ref double precision PRIMARY KEY UNIQUE REFERENCES double_precision_ref (double_precision_ref)
);

DROP TABLE IF EXISTS double_precision_check_pk;
CREATE TABLE double_precision_check_pk
(
    double_precision_check_pk double precision PRIMARY KEY
);

DROP TABLE IF EXISTS double_precision_def_const_unique_check_pk;
CREATE TABLE double_precision_def_const_unique_check_pk
(
    double_precision_def_const_unique_check_pk double precision PRIMARY KEY UNIQUE DEFAULT 42
);
...
(
    double_precision_def_const_unique_check_pk_ref double precision PRIMARY KEY UNIQUE DEFAULT 42 REFERENCES double_precision_ref (double_precision_ref)
);

DROP TABLE IF EXISTS double_precision_def_func_unique_check_pk;
CREATE TABLE double_precision_def_func_unique_check_pk
(
    double_precision_def_func_unique_check_pk double precision PRIMARY KEY UNIQUE DEFAULT 42
);
...
(
    double_precision_def_func_unique_check_pk_ref double precision PRIMARY KEY UNIQUE DEFAULT 42 REFERENCES double_precision_ref (double_precision_ref)
);
