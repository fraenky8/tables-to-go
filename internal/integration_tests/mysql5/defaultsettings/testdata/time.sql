...
(
    ...
    time_nn_check               time NOT NULL,
    time_nn_ref                 time NOT NULL REFERENCES time_ref (time_ref),
    time_nn_def_const           time NOT NULL DEFAULT '12:34:56',
    time_nn_def_func            time NOT NULL DEFAULT '12:34:56',
    time_nn_unique_check        time NOT NULL UNIQUE,

    time_unique                 time UNIQUE,
    time_unique_check           time UNIQUE,
    time_unique_ref             time UNIQUE REFERENCES time_ref (time_ref),
    time_unique_def_const       time UNIQUE   DEFAULT '12:34:56',
    time_unique_def_func        time UNIQUE   DEFAULT '12:34:56',

    time_check                  time,
    time_check_ref              time REFERENCES time_ref (time_ref),
    time_check_def_const        time          DEFAULT '12:34:56',
    time_check_def_func         time          DEFAULT '12:34:56',

    time_ref                    time REFERENCES time_ref (time_ref),
    time_ref_unique_check       time UNIQUE REFERENCES time_ref (time_ref),

    time_def_const              time          DEFAULT '12:34:56',
    time_def_const_unique_check time UNIQUE   DEFAULT '12:34:56',

    time_def_func               time          DEFAULT '12:34:56',
    time_def_func_unique_check  time UNIQUE   DEFAULT '12:34:56'
);
...
(
    time_pk_def_func time PRIMARY KEY DEFAULT '12:34:56'
);
...
(
    time_nn_unique_check_pk time PRIMARY KEY NOT NULL UNIQUE
);

DROP TABLE IF EXISTS time_nn_unique_check_pk_ref;
CREATE TABLE time_nn_unique_check_pk_ref
(
    time_nn_unique_check_pk_ref time PRIMARY KEY NOT NULL UNIQUE REFERENCES time_ref (time_ref)
);
