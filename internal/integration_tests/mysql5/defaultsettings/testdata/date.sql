...
(
    ...
    date_nn_check               date NOT NULL,
    date_nn_ref                 date NOT NULL REFERENCES date_ref (date_ref),
    date_nn_def_const           date NOT NULL DEFAULT '2020-03-01',
    date_nn_def_func            date NOT NULL DEFAULT '2020-03-01',
    date_nn_unique_check        date NOT NULL UNIQUE,

    date_unique                 date UNIQUE,
    date_unique_check           date UNIQUE,
    date_unique_ref             date UNIQUE REFERENCES date_ref (date_ref),
    date_unique_def_const       date UNIQUE   DEFAULT '2020-03-01',
    date_unique_def_func        date UNIQUE   DEFAULT '2020-03-01',

    date_check                  date,
    date_check_ref              date REFERENCES date_ref (date_ref),
    date_check_def_const        date          DEFAULT '2020-03-01',
    date_check_def_func         date          DEFAULT '2020-03-01',

    date_ref                    date REFERENCES date_ref (date_ref),
    date_ref_unique_check       date UNIQUE REFERENCES date_ref (date_ref),

    date_def_const              date          DEFAULT '2020-03-01',
    date_def_const_unique_check date UNIQUE   DEFAULT '2020-03-01',

    date_def_func               date          DEFAULT '2020-03-01',
    date_def_func_unique_check  date UNIQUE   DEFAULT '2020-03-01'
);
...
(
    date_pk_def_func date PRIMARY KEY DEFAULT '2020-03-01'
);
...
(
    date_nn_unique_check_pk date PRIMARY KEY NOT NULL UNIQUE
);

DROP TABLE IF EXISTS date_nn_unique_check_pk_ref;
CREATE TABLE date_nn_unique_check_pk_ref
(
    date_nn_unique_check_pk_ref date PRIMARY KEY NOT NULL UNIQUE REFERENCES date_ref (date_ref)
);
