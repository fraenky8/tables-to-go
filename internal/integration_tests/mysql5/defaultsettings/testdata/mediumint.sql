...
(
    ...
    mediumint_nn_check               mediumint NOT NULL,

    mediumint_unique                 mediumint UNIQUE,
    mediumint_unique_check           mediumint UNIQUE,
    ...
    mediumint_unique_def_func        mediumint UNIQUE DEFAULT 42,

    mediumint_check                  mediumint,
    mediumint_check_ref              mediumint REFERENCES mediumint_ref (mediumint_ref),
    mediumint_check_def_const        mediumint        DEFAULT 42,
    mediumint_check_def_func         mediumint        DEFAULT 42,

    mediumint_ref                    mediumint REFERENCES mediumint_ref (mediumint_ref),
    mediumint_ref_unique_check       mediumint UNIQUE REFERENCES mediumint_ref (mediumint_ref),

    mediumint_def_const              mediumint        DEFAULT 42,
    mediumint_def_const_unique_check mediumint UNIQUE DEFAULT 42,

    mediumint_def_func               mediumint        DEFAULT 42,
    mediumint_def_func_unique_check  mediumint UNIQUE DEFAULT 42
);
...
(
    mediumint_pk_def_func mediumint PRIMARY KEY DEFAULT 42
);
...
(
    mediumint_nn_unique_check_pk mediumint PRIMARY KEY NOT NULL UNIQUE
);

DROP TABLE IF EXISTS mediumint_nn_unique_check_pk_ref;
CREATE TABLE mediumint_nn_unique_check_pk_ref
(
    mediumint_nn_unique_check_pk_ref mediumint PRIMARY KEY NOT NULL UNIQUE REFERENCES mediumint_ref (mediumint_ref)
);
