...
CREATE TABLE timestamp_table (
    ...
    timestamp_nn_check timestamp NOT NULL CHECK ( timestamp_nn_check > '2020-03-01 12:34:56' ),
    ...
    timestamp_nn_unique_check timestamp NOT NULL UNIQUE CHECK ( timestamp_nn_unique_check > '2020-03-01 12:34:56' ),

    timestamp_unique timestamp UNIQUE,
    timestamp_unique_check timestamp UNIQUE CHECK ( timestamp_unique_check > '2020-03-01 12:34:56' ),
    ...
    timestamp_check timestamp CHECK ( timestamp_check > '2020-03-01 12:34:56' ),
    timestamp_check_ref timestamp CHECK ( timestamp_check_ref > '2020-03-01 12:34:56' ) REFERENCES timestamp_ref(timestamp_ref),
    timestamp_check_def_const timestamp CHECK ( timestamp_check_def_const > '2020-03-01 12:34:56' ) DEFAULT ('2020-03-01 12:34:56'),
    timestamp_check_def_func timestamp CHECK ( timestamp_check_def_func > '2020-03-01 12:34:56' ) DEFAULT (now()),

    timestamp_ref timestamp REFERENCES timestamp_ref(timestamp_ref),
    timestamp_ref_unique_check timestamp UNIQUE CHECK ( timestamp_ref_unique_check > '2020-03-01 12:34:56' ) REFERENCES timestamp_ref(timestamp_ref),

    timestamp_def_const timestamp DEFAULT ('2020-03-01 12:34:56'),
    timestamp_def_const_unique_check timestamp UNIQUE CHECK ( timestamp_def_const_unique_check > '2020-03-01 12:34:56' ) DEFAULT ('2020-03-01 12:34:56'),

    timestamp_def_func timestamp DEFAULT (now()),
    timestamp_def_func_unique_check timestamp UNIQUE CHECK ( timestamp_def_func_unique_check > '2020-03-01 12:34:56' ) DEFAULT (now())
);
