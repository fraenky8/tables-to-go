...
CREATE TABLE date_table (
    ...
    date_nn_check date NOT NULL CHECK ( date_nn_check > '2020-03-01' ),
    ...
    date_nn_unique_check date NOT NULL UNIQUE CHECK ( date_nn_unique_check > '2020-03-01' ),

    date_unique date UNIQUE,
    date_unique_check date UNIQUE CHECK ( date_unique_check > '2020-03-01' ),
    ...
    date_check date CHECK ( date_check > '2020-03-01' ),
    date_check_ref date CHECK ( date_check_ref > '2020-03-01' ) REFERENCES date_ref(date_ref),
    date_check_def_const date CHECK ( date_check_def_const > '2020-03-01' ) DEFAULT ('2020-03-01'),
    date_check_def_func date CHECK ( date_check_def_func > '2020-03-01' ) DEFAULT (now()),

    date_ref date REFERENCES date_ref(date_ref),
    date_ref_unique_check date UNIQUE CHECK ( date_ref_unique_check > '2020-03-01' ) REFERENCES date_ref(date_ref),

    date_def_const date DEFAULT ('2020-03-01'),
    date_def_const_unique_check date UNIQUE CHECK ( date_def_const_unique_check > '2020-03-01' ) DEFAULT ('2020-03-01'),

    date_def_func date DEFAULT (now()),
    date_def_func_unique_check date UNIQUE CHECK ( date_def_func_unique_check > '2020-03-01' ) DEFAULT (now())
);
