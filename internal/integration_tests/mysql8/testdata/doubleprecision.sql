...
CREATE TABLE double_precision_table (
    ...
    double_precision_nn_check double precision NOT NULL CHECK ( double_precision_nn_check > 0 ),
    ...
    double_precision_nn_unique_check double precision NOT NULL UNIQUE CHECK ( double_precision_nn_unique_check > 0 ),

    double_precision_unique double precision UNIQUE,
    double_precision_unique_check double precision UNIQUE CHECK ( double_precision_unique_check > 0 ),
    ...
    double_precision_check double precision CHECK ( double_precision_check > 0 ),
    double_precision_check_ref double precision CHECK ( double_precision_check_ref > 0 ) REFERENCES double_precision_ref(double_precision_ref),
    double_precision_check_def_const double precision CHECK ( double_precision_check_def_const > 0 ) DEFAULT 42,
    double_precision_check_def_func double precision CHECK ( double_precision_check_def_func > 0 ) DEFAULT (pi()),

    double_precision_ref double precision REFERENCES double_precision_ref(double_precision_ref),
    double_precision_ref_unique_check double precision UNIQUE CHECK ( double_precision_ref_unique_check > 0 ) REFERENCES double_precision_ref(double_precision_ref),

    double_precision_def_const double precision DEFAULT 42,
    double_precision_def_const_unique_check double precision UNIQUE CHECK ( double_precision_def_const_unique_check > 0 ) DEFAULT 42,

    double_precision_def_func double precision DEFAULT (pi()),
    double_precision_def_func_unique_check double precision UNIQUE CHECK ( double_precision_def_func_unique_check > 0 ) DEFAULT (pi())
);
