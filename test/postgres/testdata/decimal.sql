...
CREATE TABLE decimal (
    ...
    decimal_nn_check decimal NOT NULL CHECK ( decimal > 0 ),
    ...
    decimal_nn_unique_check decimal NOT NULL UNIQUE CHECK ( decimal > 0 ),

    decimal_unique decimal UNIQUE,
    decimal_unique_check decimal UNIQUE CHECK ( decimal > 0 ),
    ...
    decimal_check decimal CHECK ( decimal > 0 ),
    decimal_check_ref decimal CHECK ( decimal > 0 ) REFERENCES decimal_ref(decimal_ref),
    decimal_check_def_const decimal CHECK ( decimal > 0 ) DEFAULT 42,
    decimal_check_def_func decimal CHECK ( decimal > 0 ) DEFAULT pi(),

    decimal_ref decimal REFERENCES decimal_ref(decimal_ref),
    decimal_ref_def_const decimal REFERENCES decimal_ref(decimal_ref) DEFAULT 42,
    decimal_ref_def_func decimal REFERENCES decimal_ref(decimal_ref) DEFAULT pi(),
    decimal_ref_unique_check decimal UNIQUE CHECK ( decimal > 0 ) REFERENCES decimal_ref(decimal_ref),

    decimal_def_const decimal DEFAULT 42,
    decimal_def_const_unique_check decimal UNIQUE CHECK ( decimal > 0 )DEFAULT 42,

    decimal_def_func decimal DEFAULT pi(),
    decimal_def_func_unique_check decimal UNIQUE CHECK ( decimal > 0 ) DEFAULT pi()
);
