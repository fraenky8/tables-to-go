...
CREATE TABLE integer_table (
    ...
    integer_nn_check integer NOT NULL CHECK ( integer_nn_check > 0 ),

    integer_unique integer UNIQUE,
    integer_unique_check integer UNIQUE CHECK ( integer_unique_check > 0 ),
    ...
    integer_check_ref integer CHECK ( integer_check_ref > 0 ) REFERENCES integer_ref(integer_ref),
    integer_check_def_const integer CHECK ( integer_check_def_const > 0 ) DEFAULT 42,
    integer_check_def_func integer CHECK ( integer_check_def_func > 0 ) DEFAULT (pi()),

    integer_ref integer REFERENCES integer_ref(integer_ref),
    integer_ref_unique_check integer UNIQUE CHECK ( integer_ref_unique_check > 0 ) REFERENCES integer_ref(integer_ref),

    integer_def_const integer DEFAULT 42,
    integer_def_const_unique_check integer UNIQUE CHECK ( integer_def_const_unique_check > 0 ) DEFAULT 42,

    integer_def_func integer DEFAULT (pi()),
    integer_def_func_unique_check integer UNIQUE CHECK ( integer_def_func_unique_check > 0 ) DEFAULT (pi())
);
