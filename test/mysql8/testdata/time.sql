...
CREATE TABLE time_table (
    ...
    time_nn_check time NOT NULL CHECK ( time_nn_check > '12:34:56' ),
    ...
    time_nn_unique_check time NOT NULL UNIQUE CHECK ( time_nn_unique_check > '12:34:56' ),

    time_unique time UNIQUE,
    time_unique_check time UNIQUE CHECK ( time_unique_check > '12:34:56' ),
    ...
    time_check time CHECK ( time_check > '12:34:56' ),
    time_check_ref time CHECK ( time_check_ref > '12:34:56' ) REFERENCES time_ref(time_ref),
    time_check_def_const time CHECK ( time_check_def_const > '12:34:56' ) DEFAULT ('12:34:56'),
    time_check_def_func time CHECK ( time_check_def_func > '12:34:56' ) DEFAULT (now()),

    time_ref time REFERENCES time_ref(time_ref),
    time_ref_unique_check time UNIQUE CHECK ( time_ref_unique_check > '12:34:56' ) REFERENCES time_ref(time_ref),

    time_def_const time DEFAULT ('12:34:56'),
    time_def_const_unique_check time UNIQUE CHECK ( time_def_const_unique_check > '12:34:56' ) DEFAULT ('12:34:56'),

    time_def_func time DEFAULT (now()),
    time_def_func_unique_check time UNIQUE CHECK ( time_def_func_unique_check > '12:34:56' ) DEFAULT (now())
);
